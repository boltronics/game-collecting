...
* Fork the ``game-collecting`` repo into your account.

* Obtain the source by cloning it onto your development machine.

  .. code-block:: console

      $ git clone git@github.com:your_name_here/game-collecting.git
      $ cd game_collecting
...
* Create and activate a Python virtual environment for local development. This
  ...
  .. note::
      ...
      (game_collecting) is used to indicate when the commands
...
* Develop fix or enhancement:
  ...
  * The change should be style compliant. Perform style check.
    ...
    .. code-block:: console
        ...
        (game_collecting) $ make check-style
